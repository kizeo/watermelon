...
function markLocalChangesAsSynced(db, syncedLocalChanges) {
  ...
  _asyncToGenerator(function* () {
    ...
    yield Promise.all([db.batch.apply(db, _toConsumableArray((0, _rambdax.map)(_helpers.prepareMarkAsSynced, recordsToMarkAsSynced(syncedLocalChanges)))), destroyDeletedRecords(db, syncedLocalChanges)]);
